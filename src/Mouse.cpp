...
//==============================================================================
dVec2 Mouse::s_position{ 0.0, 0.0 };
dVec2 Mouse::s_last_position{ 0.0, 0.0 };
dVec2 Mouse::s_scroll_delta{ 0.0, 0.0 };
...
//==============================================================================
dVec2 Mouse::getPointerMovement()
{
    const dVec2 delta{ s_position - s_last_position };
...
//==============================================================================
dVec2 Mouse::getScrollMovement()
{
    const dVec2 delta{ s_scroll_delta };
...
void Mouse::reset(GLFWwindow * window)
{
    ...
    for(auto & b : s_button) b = Status::RELEASED;
}
